...
export default Gameboard = ({ navigation, route }) => {
    ...
    const savePlayerPoints = async() => {
        ...
        console.log("Points saved " + totalPoints)
    } 
    ...
    function getDiceColor(i) {
        return selectedDices[i] ? "black" : "darkgreen";
    }

    function getDicePointsColor(i) {
        return (selectedDicePoints[i] && !gameEndStatus) ? "black" : "darkgreen";
    }
    ...
    return(
        <ScrollView style={styles.gameboard}>
            ...
            <View>
                ...
                <View>
                    <Text style={styles.bonusText}>{bonusPointText}</Text>
                </View>
                <View style={styles.buttonView}>
                    <Pressable style={styles.buttonRestart} onPress={() => restartGame()}>
                        <Text style={styles.buttonText}>RESTART THE GAME</Text>
                    </Pressable>
                </View>
                <Text style={styles.gameboardTextPlayer}>Player: {playerName}</Text>
            </View>
            <Footer />
            </LinearGradient>
        </ScrollView>
